...
angle_rad = deg2rad(90);
 ...
 line([p1r(1) p2r(1)],[p1r(2) p2r(2)],[0 0],'color',[1 0 0],'linewidth',2.5);
 line([p2r(1) p3r(1)],[p2r(2) p3r(2)],[0 0],'color',[0 1 0],'linewidth',2.5);
 line([p3r(1) p4r(1)],[p3r(2) p4r(2)],[0 0],'color',[0 1 1],'linewidth',2.5);
 line([p4r(1) p1r(1)],[p4r(2) p1r(2)],[0 0],'color',[1 0 1],'linewidth',2.5);
